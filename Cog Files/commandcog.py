...
cbda_logo = "https://media.discordapp.net/attachments/807071768258805764/1143728544971763742/sdalogo.jpg"
cbda_color = 0x0E0E0E
...
class CommandCog(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        e.set_author(name="ArchiveBot Help Menu", icon_url=cbda_logo)
        e.set_thumbnail(url=cbda_logo)
    ...
    async def info(self, interaction: discord.Interaction):
	    ...
	    total_users = sum(guild.member_count for guild in self.bot.guilds)
            e = discord.Embed(color=sda_color)
            e.set_author(name="Bot Information", icon_url=cbda_logo)
            e.set_thumbnail(url=cbda_logo)
            e.add_field(
                name="📈 Index",
            ...
            e.add_field(
                name="🔗 Links",
                value=f"<:Discord:1467725136575594547> [Join CBDA!](https://discord.gg/GfbxNqmwkD)"
                      f"\n<:GitHub:1467725110172451010> [Repo Link](https://github.com/GamingDerp/CBArchiveBot)"
                      f"\n:link: [Add ArchiveBot!](https://discord.com/oauth2/authorize?client_id=1467701767880966196&permissions=414464724032&integration_type=0&scope=bot)",
                inline=False
            )
