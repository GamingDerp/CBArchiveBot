...
class IndexCog(commands.Cog):
    def __init__(self, bot):
        ...
        self.Categories = [1466997652821639286, 1466997652821639289]
    ...
    async def index_servers(self):
        ...
        self.index = index
        status.cancel()
        channel = self.bot.get_channel(1466997652163133738)
        try:
    ...
    async def random(self, ctx):
        ...
        try:
            ...
            e.description = f"<:Discord:1467725136575594547>  **[{choice[0]}]({choice[1]})**"
